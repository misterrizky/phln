<x-app-layout title="Paket Timeline {{$kegiatan->judul}} {{$kegiatan->no_loan}} | {{$kegiatan->kode_register}}">
    <div id="content_list">
                ...
                <div class="card mb-5 mb-xl-10">
                    <div class="card-header border-0 pt-5">
                        <h3 class="card-title align-items-start flex-column">
                            ...
                            <span class="text-muted mt-1 fw-bold fs-7">Timeline : {{$kegiatan->judul}} <br> {{$kegiatan->no_loan}} | {{$kegiatan->kode_register}}</span>
                        </h3>
                    </div>
