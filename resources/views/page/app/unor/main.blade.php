        ...
        <div class="card mb-5 mb-xl-10">
            <div class="card-header border-0 pt-5">
                ...
                <div class="card-toolbar">
                    <div class="row">
                        <div class="col-lg-5">
                            <a href="javascript:;" onclick="load_input('{{route('phln.unor.create',$department->id)}}');" class="btn btn-sm btn-icon btn-light btn-active-primary" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-trigger="hover" title="Klik untuk tambah data">
